#!/usr/bin/env python3
"""
run.py — SpatialClaw Multi-Channel Runner
========================================
...
logger = logging.getLogger("spatialclaw.runner")
...
async def _run_channels(channel_names: list[str], health_port: int = 0) -> None:
    ...
    core.init(
        ...
        model=os.environ.get("SPATIALCLAW_MODEL", os.environ.get("SPATIALCLAW_MODEL", "")),
    ...
    print(
        f"SpatialClaw bot running with {len(running)} channel(s): "
    ...
    try:
        ...
        print("SpatialClaw bot stopped.")


def main():
    parser = argparse.ArgumentParser(
        description="SpatialClaw Multi-Channel Bot Runner",
