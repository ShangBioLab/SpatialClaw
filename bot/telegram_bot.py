#!/usr/bin/env python3
"""
telegram_bot.py — SpatialClaw Telegram Bot (thin launcher)
========================================================
Telegram frontend for SpatialClaw spatial skills.
...
SPATIALCLAW_MODEL = os.environ.get("SPATIALCLAW_MODEL", os.environ.get("SPATIALCLAW_MODEL", ""))
