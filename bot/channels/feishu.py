"""
Feishu (Lark) channel implementation for SpatialClaw.
...
logger = logging.getLogger("spatialclaw.channel.feishu")
...
class FeishuChannel(Channel):
    ...
    def run_sync(self) -> None:
        ...
        logger.info(
            f"Starting SpatialClaw Feishu bot "
        ...
        print("SpatialClaw Feishu bot is running. Press Ctrl+C to stop.")
    ...
    def _should_respond_in_group(self, text: str, mentions: list) -> bool:
        ...
        if any(v in text for v in self._REQUEST_VERBS):
            return True
        if re.match(r"^(spatialclaw|spatialclaw|bot|助手|智能体)[\s,:，：]", text, re.IGNORECASE):
            return True
        return False
            ...
            if text:
                ...
                content_blocks.append({
                    ...
                    "text": (
                        ...
                        "transcriptomics platform. Then suggest which SpatialClaw skills "
