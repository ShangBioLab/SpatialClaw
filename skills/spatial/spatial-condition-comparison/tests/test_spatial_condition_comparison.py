"""Tests for the spatial-condition-comparison skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_condition_comparison.py"
...
def test_demo_mode(tmp_output):
    """spatial-condition-comparison --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-condition-comparison"
