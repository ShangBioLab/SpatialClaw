"""Tests for the spatial-registration skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_registration.py"
...
def test_demo_mode(tmp_output):
    """spatial-registration --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-registration"
