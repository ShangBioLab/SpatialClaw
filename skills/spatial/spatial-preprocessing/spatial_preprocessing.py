...
Usage:
    python spatial_preprocessing.py --input <data.h5ad> --output <dir>
    python spatial_preprocessing.py --demo --output <dir>
"""
...
SKILL_NAME = "spatial-preprocessing"
SKILL_VERSION = "0.1.0"
...
def write_report(output_dir: Path, summary: dict, input_file: str | None, params: dict) -> None:
    ...
    cmd = f"python spatial_preprocessing.py --input <input.h5ad> --output {output_dir}"
    for k, v in params.items():
        cmd += f" --{k.replace('_', '-')} {v}"
