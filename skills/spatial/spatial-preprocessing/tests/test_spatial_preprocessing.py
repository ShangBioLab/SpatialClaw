"""Tests for the spatial-preprocessing skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_preprocessing.py"
...
def test_demo_mode(tmp_output):
    """spatial-preprocessing --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-preprocessing"
