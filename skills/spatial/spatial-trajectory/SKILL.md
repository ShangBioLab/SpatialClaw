...
| `--method` | `dpt` | `dpt`, `cellrank`, or `palantir` |
| `--root-cell` | auto | Exact root cell barcode |
| `--n-states` | `3` | Number of terminal/trajectory states |
...
**Chaining partners**:
- `spatial-preprocessing` — QC before trajectory analysis
- `spatial-domain-identification` — Use root clustering options to specify origins
