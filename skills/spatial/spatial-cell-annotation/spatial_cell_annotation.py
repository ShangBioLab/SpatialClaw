...
Usage:
    python spatial_cell_annotation.py --input <preprocessed.h5ad> --output <dir>
    python spatial_cell_annotation.py --demo --output <dir>
    python spatial_cell_annotation.py --input <file> --method tangram --reference <sc_ref.h5ad> --output <dir>
"""
...
SKILL_NAME = "spatial-cell-annotation"
SKILL_VERSION = "0.1.0"
