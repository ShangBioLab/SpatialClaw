"""Tests for the spatial-cell-annotation skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_cell_annotation.py"
...
def test_demo_mode(tmp_output):
    """spatial-cell-annotation --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-cell-annotation"
