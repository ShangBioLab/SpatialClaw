...
Usage::
    ...
    from skills.spatial._lib.svg_detection import run_morans, run_spatialde, SUPPORTED_METHODS
...
SUPPORTED_METHODS = ("morans", "spatialde", "flashs")

# Methods that require raw counts rather than log-normalized expression.
COUNT_BASED_METHODS = ("spatialde", "flashs")
