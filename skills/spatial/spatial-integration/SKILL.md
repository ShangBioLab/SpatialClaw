...
**Key parameters**:
- `--input`: Multi-sample AnnData file.
- `--output`: Output report directory.
- `--demo`: Run the built-in integration demo.
...
**Chaining partners**:
- `spatial-preprocessing` — QC before integration
- `spatial-cell-annotation` — Label transfer post-integration
