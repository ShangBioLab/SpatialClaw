"""Tests for the spatial-integration skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_integration.py"
...
def test_demo_mode(tmp_output):
    """spatial-integration --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-integration"
