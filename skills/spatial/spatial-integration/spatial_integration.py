...
Usage:
    python spatial_integration.py --input <merged.h5ad> --output <dir> --batch-key batch
    python spatial_integration.py --demo --output <dir>
"""
...
SKILL_NAME = "spatial-integration"
SKILL_VERSION = "0.1.0"
...
def write_report(
    ...
    cmd_parts: list[str] = [f"python spatial_integration.py --input <input.h5ad> --output {output_dir}"]
    for k, v in params.items():
        if v is not None:
