"""Tests for the spatial-svg-detection skill."""
...
SKILL_SCRIPT = Path(__file__).resolve().parent.parent / "spatial_svg_detection.py"
...
def test_demo_mode(tmp_output):
    """spatial-svg-detection --demo should run without error."""
...
def test_demo_result_json(tmp_output):
    ...
    assert data["skill"] == "spatial-svg-detection"
