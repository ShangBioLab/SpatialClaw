...
layer that enables the coding-agent to run SpatialClaw skill functions
...
class TestNotebookToolsConfig:
    ...
    def test_notebook_tools_in_registry(self):
        ...
        from spatialclaw.agents.tools import build_tool_registry
    ...
    def test_skill_search_returns_results(self):
        ...
        from spatialclaw.agents.tools import skill_search
...
class TestNotebookSession:
    ...
    def test_create_notebook(self, tmp_path):
        ...
        from spatialclaw.agents.notebook_session import NotebookSession
