"""Tests for the Graph Memory Engine (spatialclaw.memory).
...
from spatialclaw.memory.database import DatabaseManager
from spatialclaw.memory.search import SearchIndexer
from spatialclaw.memory.glossary import GlossaryService
from spatialclaw.memory.graph import GraphService
from spatialclaw.memory.models import ROOT_NODE_UUID
