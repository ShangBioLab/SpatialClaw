"""Lightweight SQLite session persistence for SpatialClaw interactive CLI.

Does NOT depend on LangGraph — uses aiosqlite directly.
Sessions are stored in ~/.config/spatialclaw/sessions.db
"""
...
def get_config_dir() -> Path:
    """Return ~/.config/spatialclaw, creating it if absent."""
...
CREATE TABLE IF NOT EXISTS sessions (
    ...
    agent_name  TEXT NOT NULL DEFAULT 'SpatialClaw',
