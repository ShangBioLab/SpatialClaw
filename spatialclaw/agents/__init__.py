"""SpatialClaw Multi-Agent Research Pipeline.

Integrates EvoScientist-inspired multi-agent architecture into SpatialClaw,
...
Usage::
    ...
    from spatialclaw.agents import run_research_pipeline
...
def __getattr__(name: str):
    if name in {"MAROperator", "MemoryAugmentedReasoningOperator"}:
        from .mar_operator import MAROperator, MemoryAugmentedReasoningOperator
        return {
            "MAROperator": MAROperator,
            "MemoryAugmentedReasoningOperator": MemoryAugmentedReasoningOperator,
        }[name]
