...
try:
    ...
    _VLLM_WORKER_WRAPPER_NEEDS_CONFIG_AT_CTOR = True
except ModuleNotFoundError:
    # vLLM >= 0.7 moved WorkerWrapperBase under vllm.v1 and no longer accepts
    # vllm_config in the constructor. The config is injected later via
    # init_worker(all_kwargs).
    from vllm.v1.worker.worker_base import WorkerWrapperBase

    _VLLM_WORKER_WRAPPER_NEEDS_CONFIG_AT_CTOR = False
...
def _build_worker_wrapper(vllm_config):
    if _VLLM_WORKER_WRAPPER_NEEDS_CONFIG_AT_CTOR:
