...
QAS = None
DOCS = None
TOKENIZER_PATH = os.getenv("REMEMR1_TOKENIZER_PATH", "Qwen/Qwen2.5-3B-Instruct")
LOCAL_FILES_ONLY = os.getenv("REMEMR1_LOCAL_FILES_ONLY", "0") == "1"
FLASHRAG_DATASET_PATH = os.getenv("REMEMR1_FLASHRAG_DATASET", "RUC-NLPIR/FlashRAG_datasets")
