...
def _generate_todos(workspace: Path, mode: str, has_pdf: bool) -> None:
    ...
    stages = [
        ...
        ("Execute", "Run SpatialClaw skills in notebook", True),
    ...
    lines.extend([
        "",
        "---",
        "*Auto-generated by SpatialClaw intake. "
...
class ResearchPipeline:
    ...
    def _get_llm(self):
        ...
        model = (
            ...
            or os.getenv("SPATIALCLAW_MODEL")
        )
    ...
    def _build_agent(self):
        """Build the deepagents agent with SpatialClaw sub-agents.
        ...
        # Skills backend (read-only, maps /skills/ → SpatialClaw skills/)
    ...
    def _build_initial_prompt(self, intake) -> str:
        ...
        parts = [
            ...
            "The user wants to conduct a spatial analysis research project. "
