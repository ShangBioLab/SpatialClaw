"""
SpatialClaw Memory — graph-backed typed memory system.
...
Provides:
  ...
  - LayeredMemoryStore — typed episodic / semantic memory API

Usage (lazy init):

    from spatialclaw.memory import get_graph_service, get_db_manager
...
from .layered_store import LayeredMemoryStore
from .types import (
    AnalysisMemory,
    BaseMemory,
    DatasetMemory,
...
def _ensure_initialized():
    ...
    database_url = os.getenv("SPATIALCLAW_MEMORY_DB_URL")
...
__all__ = [
    ...
    "close_db",
    "LayeredMemoryStore",
    "Session", "BaseMemory", "DatasetMemory", "AnalysisMemory",
    "PreferenceMemory", "InsightMemory", "ProjectContextMemory",
