"""SpatialSession — upload once, analyse many times.

Stores metadata about a spatial dataset and accumulated skill results
...
class SpatialSession:
    """In-memory spatial analysis session with JSON persistence."""
    ...
    def __init__(
        ...
        self.primary_data_path: str = primary_data_path
    ...
    @classmethod
    def load(cls, path: str | Path) -> "SpatialSession":
        ...
        return cls(
            ...
            primary_data_path=data.get("primary_data_path", ""),
    ...
    def __repr__(self) -> str:
        ...
        return f"SpatialSession(id={sid!r}, domain={domain!r}, type={dtype!r}, skills={skills})"
